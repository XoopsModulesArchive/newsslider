...
function list_groups2() {
    ...
    $form = new MyXoopsGroupPermForm( _MD_AM_NWS_ADGS , 1 , 'block_read' , '' ) ;
    if ( $target_mid > 1 ) {
        $form->addAppendix( 'module_admin' , $target_mid , $target_mname . ' ' . _AM_NWS_ACTIVERIGHTS ) ;
        $form->addAppendix( 'module_read' , $target_mid , $target_mname .' ' . _AM_NWS_ACCESSRIGHTS ) ;
    }
...
if ( ! empty( $block_arr ) ) {
    echo "<h4 style='text-align:left;'>"._AM_NWS_BADMIN."</h4>\n" ;
    list_blockinstances() ;
}
